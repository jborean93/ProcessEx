...
task BuildManaged {
    $arguments = @(
        ...
        # On a compiler failure a background dotnet process continues to live
        # on keeping the user profile open. The ElevatePrivileges.ps1 runner
        # requires everything to have finished for it to complete so disabling
        # this will ensure dotnet doesn't have any lingering child processes.
